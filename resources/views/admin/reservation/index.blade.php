                ...
                @foreach ($reservations as $reservation)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.reservation.destroy', ['id' => $reservation->id]) }}" method="post" onsubmit="return window.confirm('Êtes-vous sûr de vouloir supprimer la réservation {{ $reservation->id }} ?');">
                            @csrf
                            @method('DELETE')
